(function (factory) {
    ...
    $.extend($.summernote.plugins, {
        'emoji': function (context) {
            var self = this, KEY_ESC = 27, KEY_TAB = 9, ui = $.summernote.ui, icons = {}, reverseIcons = {}
            ...
            var chunk = function (val, chunkSize) {
                var R = []
                for (let i = 0; i < val.length; i += chunkSize) { R.push(val.slice(i, i + chunkSize)) }
                return R
            }
            /* IE polyfill*/
            ...
            context.memo('button.emoji', function () {
                if (document.emojiButton === undefined) { document.emojiButton = 'fa fa-smile-o' }
